...
// Models returns the known antigravity model ids from the embedded catalog baseline.
// Antigravity has no stable public model-list API and is not listed on models.dev,
